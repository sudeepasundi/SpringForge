...
import { tally } from './tally-project';
 ...
 * the MySQL project behind the Spring JDBC section; Tally is the plain-Java
 * project behind the Java section.
 */
export const demos: DemoProject[] = [taskly, shopflow, relay, shelf, tally];
